...
private:
    ...
    void addPurchaseTransaction(const QueryRequest &request, QueryResult &result,
                                TransactionMode mode = TransactionMode::UseSqlTransaction); // throws DatabaseException
