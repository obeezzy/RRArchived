...
AddUser::AddUser(const Utility::User::User& user, QObject* receiver)
    ...
    try {
        ...
        switch (e.code()) {
            ...
            case static_cast<int>(
                ...
                throw UserPreviouslyArchivedException(
                    QStringLiteral("User '%1' has been archived. "
                                   "Unarchive the user or create a user with "
                                   "another name.")
                        .arg(userName));
            default:
                throw;
...
int AddUser::addRRUser()
{
    ...
    const int noteId = QueryExecutor::addNote(
        note, QStringLiteral("user"), ExceptionPolicy::DisallowExceptions);
    ...
    const auto& records(callProcedure(
        ...
        {ProcedureArgument{ProcedureArgument::Type::In, "user",
         ...
         ProcedureArgument{ProcedureArgument::Type::In, "photo",
                           QueryExecutor::imageUrlToByteArray(
                               params.value("image_url").toUrl())},
         ProcedureArgument{ProcedureArgument::Type::In, "phone_number",
                           params.value("phone_number")},
         ProcedureArgument{ProcedureArgument::Type::In, "email_address",
...
void AddUser::addUserPrivileges(int userId)
{
    ...
    callProcedure(
        ...
        {ProcedureArgument{ProcedureArgument::Type::In, "user_privileges",
         ...
         ProcedureArgument{ProcedureArgument::Type::In, "user_id", userId}});
}
...
void AddUser::addSqlUser()
{
    ...
    callProcedure("AddSqlUser",
                  {ProcedureArgument{ProcedureArgument::Type::In, "user",
                                     params.value("user")},
                   ProcedureArgument{ProcedureArgument::Type::In, "password",
