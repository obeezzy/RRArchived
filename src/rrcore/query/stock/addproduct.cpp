...
AddProduct::AddProduct(const Utility::Stock::Product& product,
    ...
    : StockExecutor(
          COMMAND,
          {
              ...
              {"tracked",
               product.flags.testFlag(Utility::RecordGroup::Tracked)},
              {"divisible",
               product.flags.testFlag(Utility::RecordGroup::Divisible)},
              ...
              {"unit_preferred",
               product.unit.flags.testFlag(Utility::RecordGroup::Preferred)},
...
int AddProduct::addProduct(int productCategoryId)
{
    ...
    const auto noteId = QueryExecutor::addNote(
        note, QStringLiteral("product"), ExceptionPolicy::DisallowExceptions);

    const auto& records = callProcedure(
        "AddProduct",
        {ProcedureArgument{ProcedureArgument::Type::In, "product_category_id",
                           productCategoryId},
         ProcedureArgument{ProcedureArgument::Type::In, "product",
                           params.value("product")},
         ProcedureArgument{ProcedureArgument::Type::In, "short_form",
                           params.value("short_form")},
         ProcedureArgument{ProcedureArgument::Type::In, "description",
                           params.value("description")},
         ProcedureArgument{ProcedureArgument::Type::In, "barcode",
                           params.value("barcode")},
         ProcedureArgument{ProcedureArgument::Type::In, "divisible",
                           params.value("divisible")},
         ProcedureArgument{ProcedureArgument::Type::In, "image", imageBlob},
         ProcedureArgument{ProcedureArgument::Type::In, "note_id", noteId},
         ProcedureArgument{ProcedureArgument::Type::In, "user_id",
                           UserProfile::instance().userId()}});
    ...
    if (records.isEmpty())
        throw UnexpectedResultException(
            QStringLiteral("Expected product ID, received nothing."));
...
int AddProduct::addProductUnit(int productId)
{
    ...
    const int noteId = QueryExecutor::addNote(
        note, QStringLiteral("unit"), ExceptionPolicy::DisallowExceptions);

    const auto& records = callProcedure(
        "AddProductUnit",
        {ProcedureArgument{ProcedureArgument::Type::In, "product_id",
                           productId},
         ProcedureArgument{ProcedureArgument::Type::In, "unit",
                           params.value("product_unit")},
         ProcedureArgument{ProcedureArgument::Type::In, "short_form",
                           params.value("short_form")},
         ProcedureArgument{ProcedureArgument::Type::In, "base_unit_equivalent",
                           params.value("base_unit_equivalent")},
         ProcedureArgument{ProcedureArgument::Type::In, "cost_price",
                           params.value("cost_price")},
         ProcedureArgument{ProcedureArgument::Type::In, "retail_price",
                           params.value("retail_price")},
         ProcedureArgument{ProcedureArgument::Type::In, "preferred",
    ...
    if (records.isEmpty())
        throw UnexpectedResultException(
            QStringLiteral("Expected product unit ID, received nothing."));
