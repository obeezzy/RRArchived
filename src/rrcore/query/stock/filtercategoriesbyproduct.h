...
namespace Query {
    ...
    class FilterCategoriesByProduct : public StockExecutor
    {
        Q_OBJECT
    public:
        static inline const QString COMMAND = QStringLiteral("filter_categories_by_product");

        explicit FilterCategoriesByProduct(const Utility::FilterCriteria &filterCriteria,
