...
FilterCategoriesByProduct::FilterCategoriesByProduct(const Utility::FilterCriteria &filterCriteria,
...
QueryResult FilterCategoriesByProduct::execute()
{
    ...
    try {
        const auto &records(callProcedure("FilterCategoriesByProduct", {
                                              ProcedureArgument {
