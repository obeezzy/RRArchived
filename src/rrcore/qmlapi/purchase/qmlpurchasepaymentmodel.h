...
#include "utility/purchase/purchasepayment.h"

class QMLPurchasePaymentModel : public AbstractVisualListModel
{
    Q_OBJECT
    Q_PROPERTY(double totalAmount READ totalAmount WRITE setTotalAmount NOTIFY
                   totalAmountChanged)
public:
    enum Roles
    {
    ...
    void addPayment(const Utility::Purchase::PurchasePayment& payment);
...
private:
    Utility::Purchase::PurchasePaymentList m_payments;
