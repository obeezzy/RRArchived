...
class QMLDebtTransactionModel : public AbstractVisualListModel
{
    Q_OBJECT
    Q_PROPERTY(
        int debtorId READ debtorId WRITE setDebtorId NOTIFY debtorIdChanged)
    Q_PROPERTY(
    ...
    Q_PROPERTY(QString preferredName READ preferredName WRITE setPreferredName
                   NOTIFY preferredNameChanged)
...
public:
    ...
    Q_INVOKABLE void addDebt(double totalDebt, const QDateTime& dueDateTime,
...
private:
    bool m_dirty{false};
    Utility::Debtor::Debtor m_debtor;
