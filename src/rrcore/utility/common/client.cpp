...
Client::Client(const QString& preferredName) : preferredName(preferredName) {}

Client::Client(int id, const QString& preferredName, const QString& phoneNumber)
    : id(id),
      preferredName(preferredName),
      phoneNumber(phoneNumber)
{}

Client::Client(const QString& preferredName, const QString& phoneNumber,
               const QString& firstName, const QString& lastName,
               const QUrl& imageUrl, const QString& emailAddress)
    : preferredName(preferredName),
      phoneNumber(phoneNumber),
      firstName(firstName),
      lastName(lastName),
