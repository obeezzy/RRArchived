...
ProductQuantity::ProductQuantity(int num) :
    m_value(num)
{}

ProductQuantity::ProductQuantity(qlonglong num) :
    m_value(num)
{}

ProductQuantity::ProductQuantity(qulonglong num) :
    m_value(num)
{}

ProductQuantity::ProductQuantity(float num) :
    m_value(num)
{
    if (decPart() > 4)
        m_value.round(4);
...
ProductQuantity::ProductQuantity(double num) :
    m_value(num)
{
    if (decPart() > 4)
        m_value.round(4);
...
ProductQuantity::ProductQuantity(long double num) :
    m_value(num)
{
    if (decPart() > 4)
        m_value.round(4);
...
int ProductQuantity::toInt(const ProductUnit &unit) const
{
    if (m_productId != unit.productId) {
        qCWarning(lcstockproductquantity).nospace() << "Product ID mismatch: ProductQuantity("
                                             << m_productId
                                             << "), ProductUnit("
                                             << unit.productId
                                             << "). Aborting...";
