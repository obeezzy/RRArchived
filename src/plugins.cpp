...
void Plugins::registerTypes()
{
    ...
    // * Stock
    qmlRegisterType<QMLProductCategoryModel>("com.gecko.rr.models", 1, 0, "ProductCategoryModel");
    qmlRegisterType<QMLProductCountRecord>("com.gecko.rr.models", 1, 0, "ProductCountRecord");
    qmlRegisterType<QMLProductDetailModel>("com.gecko.rr.models.stock", 1, 0, "ProductDetailModel");
    qmlRegisterType<QMLProductPusher>("com.gecko.rr.models", 1, 0, "ProductPusher");
    qmlRegisterType<QMLProductModel>("com.gecko.rr.models", 1, 0, "ProductModel");
