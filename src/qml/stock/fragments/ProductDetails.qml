...
Item {
    ...
    readonly property string category: privateProperties.newlyEnteredCategory ? privateProperties.newlyEnteredCategory : categoryComboBox.currentText
    readonly property string product: productTextField.text
    ...
    readonly property string productNote: ""
            ...
            Row {
                ...
                QQC2.ComboBox {
                    ...
                    model: RRModels.StockProductCategoryModel {
                        onSuccess: categoryComboBox.currentIndex = categoryComboBox.find(stockProductDetailRecord.category)
                    }
                ...
                QQC2.Label {
                    ...
                    width: 200
                    font.pixelSize: 17
                    color: privateProperties.newlyEnteredCategory === "" ? Material.color(Material.Grey) : Material.theme === Material.Dark ? "white" : "black"
                    text: privateProperties.newlyEnteredCategory === "" ? privateProperties.defaultCategoryText : privateProperties.newlyEnteredCategory
                ...
                RRUi.ToolButton {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    icon.source: FluidControls.Utils.iconUrl(privateProperties.newlyEnteredCategory ? "content/remove_circle" : "content/add_circle")
                    text: privateProperties.newlyEnteredCategory ? qsTr("Remove category") : qsTr("Add category")
                    onClicked: {
        ...
        RRUi.SectionFragment {
            ...
            Row {
                ...
                QQC2.SpinBox {
                    ...
                    up.indicator: null
                    width: 50
                    editable: productDetails.productId <= 0
                    to: 10000
    ...
    RRModels.StockProductDetailRecord {
        id: stockProductDetailRecord

        autoQuery: productDetails.productId > 0
