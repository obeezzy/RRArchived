...
RRUi.Dialog {
    ...
    function show(paymentModelData, paymentModel) {
        ...
        else if (paymentModel && paymentModel.rowCount() > 0 && Object(paymentModel.get(paymentModel.rowCount() - 1)).hasOwnProperty("max_payable_amount"))
        ...
        Row {
            ...
            RRUi.TextField {
                ...
                validator: RRComponents.DoubleValidator {
                    bottom: 0
                    top: amountPaidDialog.maxPayableAmount
                }
