...
RRUi.DataTableView {
    ...
    function removeTransaction(transactionId) {
        incomeTransactionTableView.model.removeTransaction(transactionId);
    }

    function refresh() {
        incomeTransactionTableView.model.refresh();
    }

    function undoLastCommit() {
        incomeTransactionTableView.model.undoLastCommit();
    }
