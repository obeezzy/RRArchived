...
RRUi.WizardPage {
    ...
    hasNext: true
    onNext: {
        paymentByCardPage.cartModel.addPayment(paymentByCardPage.amountPaid, paymentByCardPage.paymentMethod === "debit_card" ? RRModels.SaleCartModel.DebitCard : RRModels.SaleCartModel.CreditCard);
        if (paymentByCardPage.hasDebt || paymentByCardPage.hasCredit) {
            ...
            paymentByCardPage.nextPage.properties = {
                ...
                "canAcceptAlternatePaymentMethod": paymentByCardPage.cartModel.canAcceptCash || paymentByCardPage.canAcceptCard,
                "isCashPayment": false,
                "totalCost": paymentByCardPage.cartModel.totalCost,
                "cartModel": paymentByCardPage.cartModel
            };
        } else if (paymentByCardPage.cartModel.customerName.trim() === "" || paymentByCardPage.cartModel.customerPhoneNumber.trim() === "") {
