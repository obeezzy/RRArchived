...
RRUi.Page {
    ...
    function goToNextDay() {
        if (selectedDate < todaysDate) {
            ...
            selectedDate = new Date(expenseTransactionPage.selectedDate.getFullYear(), expenseTransactionPage.selectedDate.getMonth(), expenseTransactionPage.selectedDate.getDate() + 1);
        ...
        RRUi.Card {
            ...
            contentItem: FocusScope {
                ...
                ExpenseTransactionTableView {
                    ...
                    from: new Date(expenseTransactionPage.selectedDate.getFullYear(), expenseTransactionPage.selectedDate.getMonth(), expenseTransactionPage.selectedDate.getDate())
                    to: new Date(expenseTransactionPage.selectedDate.getFullYear(), expenseTransactionPage.selectedDate.getMonth(), expenseTransactionPage.selectedDate.getDate() + 1)
                    onSuccess: {
                        switch (result.code) {
