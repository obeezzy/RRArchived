        ...
        component: Item {
            ...
            Flickable {
                ...
                RRUi.Card {
                    ...
                    RRModels.ExpensePusher {
                        id: expensePusher

                        clientName: clientTextField.text
                        purpose: purposeTextField.text
                        amount: amountSpinBox.value
                        paymentMethod: creditCardRadioButton.checked ? RRModels.ExpensePusher.CreditCard : debitCardRadioButton.checked ? RRModels.ExpensePusher.DebitCard : RRModels.ExpensePusher.Cash
                        onSuccess: {
                            switch (result.code) {
