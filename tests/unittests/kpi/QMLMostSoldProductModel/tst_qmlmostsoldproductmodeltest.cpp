...
void QMLMostSoldProductModelTest::testViewMostSoldProducts()
{
    const QVariantList products{
        QVariantMap{{"product_category_id", 1},
        ...
        QVariantMap{{"product_category_id", 1},
                    ...
                    {"product_unit_id", 1},
                    {"product_unit", "product(s)"}},
        QVariantMap{{"product_category_id", 2},
    ...
    QSignalSpy busyChangedSpy(m_mostSoldProductModel,
                              &QMLMostSoldProductModel::busyChanged);
    QSignalSpy errorSpy(m_mostSoldProductModel,
                        &QMLMostSoldProductModel::error);
    QSignalSpy successSpy(m_mostSoldProductModel,
                          &QMLMostSoldProductModel::success);
    ...
    // Rows with columns
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            0, QMLMostSoldProductModel::ProductColumn),
                        Qt::DisplayRole)
                 .toString(),
             products[0].toMap()["product"].toString());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            0, QMLMostSoldProductModel::TotalQuantityColumn),
                        Qt::DisplayRole)
                 .toDouble(),
             products[0].toMap()["total_quantity"].toDouble());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            0, QMLMostSoldProductModel::TotalRevenueColumn),
                        Qt::DisplayRole)
                 .toDouble(),
    ...
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            1, QMLMostSoldProductModel::ProductColumn),
                        Qt::DisplayRole)
                 .toString(),
             products[1].toMap()["product"].toString());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            1, QMLMostSoldProductModel::TotalQuantityColumn),
                        Qt::DisplayRole)
                 .toDouble(),
             products[1].toMap()["total_quantity"].toDouble());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            1, QMLMostSoldProductModel::TotalRevenueColumn),
                        Qt::DisplayRole)
                 .toDouble(),
    ...
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            2, QMLMostSoldProductModel::ProductColumn),
                        Qt::DisplayRole)
                 .toString(),
             products[2].toMap()["product"].toString());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            2, QMLMostSoldProductModel::TotalQuantityColumn),
                        Qt::DisplayRole)
                 .toDouble(),
             products[2].toMap()["total_quantity"].toDouble());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(
                            2, QMLMostSoldProductModel::TotalRevenueColumn),
                        Qt::DisplayRole)
                 .toDouble(),
    ...
    // All rows
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::ProductCategoryIdRole)
                 .toInt(),
             products[0].toMap()["product_category_id"].toInt());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::ProductCategoryRole)
                 .toString(),
             products[0].toMap()["product_category"].toString());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::ProductIdRole)
                 .toInt(),
             products[0].toMap()["product_id"].toInt());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::ProductRole)
                 .toString(),
             products[0].toMap()["product"].toString());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::TotalRevenueRole)
                 .toDouble(),
             products[0].toMap()["total_revenue"].toDouble());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::TotalQuantityRole)
                 .toDouble(),
             products[0].toMap()["total_quantity"].toDouble());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::ProductUnitIdRole)
                 .toInt(),
             products[0].toMap()["product_unit_id"].toInt());
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(0, 0),
                        QMLMostSoldProductModel::ProductUnitRole)
                 .toString(),
             products[0].toMap()["product_unit"].toString());

    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(1, 0),
                        QMLMostSoldProductModel::ProductCategoryIdRole)
                 .toInt(),
    ...
    QCOMPARE(m_mostSoldProductModel
                 ->data(m_mostSoldProductModel->index(2, 0),
                        QMLMostSoldProductModel::ProductCategoryIdRole)
                 .toInt(),
